...
- Prototype: (https://gig-shield-six.vercel.app/)
...
can reduce deliveries and lead to **20–30% loss in weekly income**.
...
- The system monitors real-time environmental data  
...
3. User selects a weekly insurance plan  
4. System monitors real-time environmental data  
5. If disruption occurs → payout is triggered automatically  
...
**Example:**
- Daily income: ₹600–₹800  
- Weekly loss during disruptions: ₹1000–₹1500  
...
### How Money is Credited

When a disruption occurs (rain, heatwave, pollution, etc.), the system automatically processes payouts.

**Step-by-step flow:**

1. Environmental data crosses the defined threshold  
2. System detects a disruption event  
3. Eligible users are identified based on active plans  
4. Fraud check is performed using AI  
5. Payout amount is calculated based on estimated income loss  
6. Payment is processed via Razorpay  

- The compensation is directly credited to the user's **UPI / bank account** within minutes.
...
- Maximum payout is limited based on the selected plan  

## Example:
If a user has a **Standard Plan (₹3000 max payout)**  
and loses ₹400 due to heavy rain → ₹400 is credited instantly  
...
>>>>>>> b53918b71f817181cd1b7b40f354caa5b5ec4d32
